      ...
      <div class="registerCont">
        <ul>
          ...
          <li class="agree">
            ...
            我同意《<NuxtLink to="#" target="_black">人人拍卖注册协议</NuxtLink
            >》
            <span>请查看协议</span>
          </li>
          <li class="btn">
...
export default {
  ...
  methods: {
    ...
    send() {
      ...
      this.$axios.$get("/sms/send/" + this.userInfo.phone).then((response) => {
    ...
    //注册
    register() {
      // this.$axios.$post("/login/userAddress/test", this.userInfo).then((response) => {
      //   // this.step = 2;
      //   console.log(response);
      // });
      this.$axios
        .$post("/login/userInfo/register", this.userInfo)
        .then((response) => {
