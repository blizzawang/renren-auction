  ...
  <div class="personal-main">
    <div class="pmain-profile">
      <div class="pmain-welcome">
        ...
        <span class="fr">最近登录时间： {{ userIndexVO.loginTime }} </span>
      </div>
        ...
        <div class="user-info">
          <ul>
            <li>
              ...
              <!-- <NuxtLink v-if="userIndexVO.bindStatus === 1" to="/user/borrower">
                立即借款
              </NuxtLink> -->
            </li>
...
export default {
  ...
  methods: {
    fetchUserData() {
      ...
      this.$axios.$get("/login/userInfo/getInfo/" + userId).then((response) => {
        let jsonData = JSON.stringify(response.data.simpleUserInfoVo);
        this.userIndexVO = JSON.parse(jsonData);
        console.log(this.userIndexVO);
      });
    },
  },
};
