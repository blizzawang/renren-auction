        ...
        <form id="form" name="form" method="post" action="">
          <div class="quick-main">
            ...
            <div class="pay-tipcon" style="height: 110px;">
              <b>温馨提示：</b><br />
              1、为了您的资金安全，您的账户资金由人人拍卖平台进行托管。<br />
...
export default {
  ...
  methods: {
    commitCharge() {
      ...
      this.$alert(
        '<div style="size: 18px;color: red;">您即将前往支付宝进行充值</div>',
        "前往支付宝平台",
        {
          ...
          callback: (action) => {
            if (action === "confirm") {
              ...
              this.$axios
                .$post(
                  "/login/userAccount/auth/commitCharge/1/" +
                    this.userId +
                    "/" +
                    this.chargeAmt
                )
                .then((response) => {
                  // console.log(response.data.payForm);
                  document.write(response.data.payForm);
                });
            }
          },
        }
