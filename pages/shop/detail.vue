<template>
  <div>
    <img-zoom
      ...
      :configs="configs"
    ></img-zoom>
    <div style="border:1px red solid;width:40%;float:right;margin-right:350px">
      <p
      ...
      >
        ...
        <span style="color:#c00;font-size:19px;margin-left:70px">张三XXX</span>
      </div>
...
export default {
  ...
  data() {
    return {
      shopInfo: {},
      shopId: 0, // 商品id
      offerPrice: 1000, // 买家出价
      srcImageUrl:
        "https://renren-auction.oss-cn-beijing.aliyuncs.com/shop-test/59ded626Ne3c69b70.jpg",
      bigImageUrl:
        "https://renren-auction.oss-cn-beijing.aliyuncs.com/shop-test/59ded626Ne3c69b71.jpg",
      configs: {
        width: 650,
        height: 350,
        maskWidth: 100,
